...
def main():
    csv_path = "./gt_contracts/compiled_gt_contracts.csv"
    ground_truth_path = "../data/sample_of_interest.csv"
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            try:
                ...
                with open("gas_report_all_contracts_ground_truth.json", "w") as f:
